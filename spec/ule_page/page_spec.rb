...
describe UlePage::Page do
  ...
  describe "#fill_form" do
    ...
    it 'non specify parameter should fill all the fields' do
      ...
      expect(recorder.has_key?('#customer_name')).to be_truthy
      expect(recorder.has_key?('#customer_age')).to be_truthy
    end
    ...
    it 'specify parameter should only fill the specified' do
      ...
      expect(recorder.has_key?('#customer_name')).to be_truthy
      expect(recorder.has_key?('#customer_age')).to be_falsy
    end
    ...
    it 'specify the mapper' do
      ...
      page.fill_form customer, [:name, :age], { :alias_name => "name", :alias_age => "age" }
